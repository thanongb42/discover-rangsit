...
class HomeController extends Controller {
    public function index() {
        ...
        $this->view('home/index', [
            ...
            'keywords'        => 'ของดีรังสิต, ของดีเมืองรังสิต, ของดีนครรังสิต, ของดีย่านรังสิต, ของกินรังสิต, ร้านค้ารังสิต, ร้านอาหารรังสิต, ร้านดังรังสิต, ร้านดังย่านรังสิต, ร้านเด็ดย่านรังสิต, คาเฟ่รังสิต, เที่ยวรังสิต, ที่เที่ยวรังสิต, ของเด็ดรังสิต, ของดังรังสิต, ก๋วยเตี๋ยวเรือรังสิต, เทศบาลนครรังสิต, Discover Rangsit',
            'og_url'          => BASE_URL . '/',
            'places'          => $places,
