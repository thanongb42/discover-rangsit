...
$router->get('/3dmap', 'MapController', 'threeD');
$router->get('/tourism', 'CivicController', 'tourism');
$router->get('/events', 'CivicController', 'events');
$router->get('/open-data', 'CivicController', 'openData');
$router->get('/open-data/places.json', 'CivicController', 'openDataPlacesJson');
$router->get('/open-data/places.csv', 'CivicController', 'openDataPlacesCsv');
$router->get('/refill-city', 'CivicController', 'refillCity');
